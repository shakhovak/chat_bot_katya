...
> Дополнительно развернула docker image с ботом наа ВМ d Yandex Cloud по ссылке(http://84.201.157.133:5000). Здесь платный ресурс, но тоже без GPU, поэтому кол-во кандидатов тоже 5. Субъективно, на платной машине быстрее работает. 
