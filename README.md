...
> - Дополнительно развернула docker image с ботом наа ВМ d Yandex Cloud по [ссылке](http://178.154.202.151:5000). Здесь платный ресурс, но тоже без GPU. Субъективно, на платной машине быстрее работает. 
